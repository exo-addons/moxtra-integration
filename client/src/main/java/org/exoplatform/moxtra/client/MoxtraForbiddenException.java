...
/**
 * Moxtra service returned 403 Forbidden response.<br>
 * 
...
public class MoxtraForbiddenException extends MoxtraAccessException {
   ...
   * 
   */
  private static final long serialVersionUID = -4571327072618106785L;

  /**
   * @param message
   */
  public MoxtraForbiddenException(String message) {
    super(message);
  }
}
